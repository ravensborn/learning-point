    ...
    <div class="page-header d-print-none">
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <h2 class="page-title">
                        Manage {{ ucfirst($teacher->name) }} Transactions
                    </h2>
                </div>
                <!-- Page title actions -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between w-100">
                                ...
                                <div @class(['text-danger' => ($teacher->wallet < 0)])>
                                    Wallet:
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="d-flex flex-column gap-2 mt-3 justify-center">
                                        @forelse($transferToList as $teacher)
                                            @if($teacher->id == $transferToId)
                                                <div class="badge cursor-pointer border-success">
                                                    {{ $teacher->name }}
                                                </div>
                                            @else
                                                <div class="badge cursor-pointer"
                                                     wire:click="selectTransferTo({{ $teacher->id }})">
                                                    {{ $teacher->name }}
                                                </div>
                                            @endif
                                        @empty
                    ...
                    @else
                        <div>
                            Teacher has insufficient wallet amount.
                        </div>
                    @endif

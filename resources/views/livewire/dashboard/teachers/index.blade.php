<div>
                    ...
                    <div class="card">
                                    ...
                                    <tr wire:key="{{ $teacher->id }}">
                                        ...
                                        <td>
                                                <span class="text-secondary">
                                                    {{ ($teachers->currentpage()-1) * $teachers->perpage() + $loop->index + 1 }}
                                                </span>
                                        </td>
                                        ...
                                        <td @class(['text-danger' => ($teacher->wallet < 0)])>
                                        ...
                                        <td class="text-end">
                                            <a class="btn align-text-top"
                                               href="{{ route('dashboard.teacher.transactions.index', ['teacher' => $teacher->id]) }}">
                                            ...
                                            <span class="dropdown">
                                                  ...
                                                  <div class="dropdown-menu dropdown-menu-end">
                                                    <button class="dropdown-item"
                                                            wire:click="prepareItemEditing({{ $teacher->id  }})">Edit</button>
                                                    <button class="dropdown-item"
                                                            wire:click="prepareItemDeletion({{ $teacher->id }})">Delete</button>
                                                  </div>
                                                </span>
                                        </td>
                                    </tr>
                        ...
                        <div class="card-footer d-flex align-items-center">
                            <p class="m-0 text-secondary">
                                Showing
                                <span>{{  $teachers->firstItem()  }}</span>
                                to
                                <span>{{ $teachers->lastItem() }}</span>
                                of
    ...
    <div class="modal modal-blur fade" id="modal-edit" tabindex="-1" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Editing teacher {{ $form->name }} </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">

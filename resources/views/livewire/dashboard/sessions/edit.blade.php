                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                <div class="col-12 text-warning">
                                    ...
                                    <span>Making any change will result in system managed charges on a to be charged student to refresh.</span>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select id="teacher_id" class="form-control"
                                            wire:model.live="sessionForm.teacher_id">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select id="subject_id" class="form-control"
                                            wire:model.live="sessionForm.subject_id">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="note" class="form-control"
                                              wire:model="sessionForm.approval_note"></textarea>
